...
/**
 * Interfaz que define las operaciones disponibles para el servicio de reservaciones. Proporciona métodos para crear,
 * leer, actualizar y eliminar reservaciones.
 */
public interface ReservationService {
     ...
     *            DTO con los datos de la reservación a validar y crear
     *
     ...
     *
     * @param reservationDTO
     *            DTO con los datos de la reservación a crear
     *
     * @return DTO de la reservación creada
     *
     * @throws ResourceNotFoundException
     *             si ya existe una reservación con el ID proporcionado
     */
     ...
     *
     * @param id
     *            Identificador único de la reservación a actualizar
     * @param reservationDTO
     *            DTO con los nuevos datos de la reservación
     *
     ...
     *
     * @param id
     *            Identificador único de la reservación a eliminar
     *
     * @throws ResourceNotFoundException
     *             si no se encuentra la reservación
     */
